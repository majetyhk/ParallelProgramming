...
int main(int argc, char *argv[])
{
  ...
  startValueY = 0; // assign starting and ending indices on x and y axes in the lake for different processes based on rank
  endValueY = npoints-1;

  startValueX = rank * (npoints/4); 
  endValueX = startValueX + npoints/4 -1;
